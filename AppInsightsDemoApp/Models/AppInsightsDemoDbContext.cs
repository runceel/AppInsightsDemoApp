...
namespace AppInsightsDemoApp.Models
{
    public partial class AppInsightsDemoDbContext : DbContext
    {
        public AppInsightsDemoDbContext()
        {
        }

        public AppInsightsDemoDbContext(DbContextOptions<AppInsightsDemoDbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BuildVersion>(entity =>
            {
                entity.HasKey(e => e.SystemInformationId)
                    .HasName("PK__BuildVer__35E58ECA34C549B7");
